...
void Back(bool &x1,bool &x2,bool &x3,bool &x4, bool &x5) {
	if (x1 == false && x2 == true) {
		x1 = true; x2 = false;
	} else if (x2 == false && x3 == true) {
		x2 = true; x3 = false;
	} else if (x2 == false && x4 == true) {
		x2 = true; x4 = false;
	} else if (x2 == false && x5 == true) {
		x2 = true; x5 = false;
	}
}
...
string WaitSB() {
	string Pic;
	string STB2 = "STB2.jpg", STB3 = "STB3.jpg", STB5 = "STB5.jpg", STB6 = "STB6.jpg";
	int i = Random(1, 4);
	if (i == 1) {
		Pic = STB2;
	}
...
string WaitT() {
	string Pic;
	string TB1 = "TB1.jpg", TB2 = "TB2.jpg", TB5 = "TB5.jpg", TB6 = "TB6.jpg", STB1 = "STB1.jpg";
	int i = Random(1, 5);
	if (i == 1) {
		Pic = TB1;
	}
...
string WaitP() {
	string Pic;
	string PB1 = "PB1.jpg", PB2 = "PB2.jpg", PB3 = "PB3.jpg", PB4 = "PB4.jpg", PB5 = "PB5.jpg", PB6 = "PB6.jpg", PB7 = "PB7.jpg";
	int i = Random(1, 7);
	if (i == 1) {
		Pic = PB1;
	}
...
string WaitB() {
	string Pic;
	string BB1 = "BB1.jpg", BB2 = "BB2.jpg", BB3 = "BB3.jpg", BB4 = "BG4.jpg", BB6 = "BB6.jpg";
	int i = Random(1, 5);
	if (i == 1) {
		Pic = BB1;
	}
...
int main() {
	...
	sf::RenderWindow window(sf::VideoMode(1366, 666), "Train");
	...
	string Pic[5] = {"Loading", "Loading.", "Loading..", "Loading...", "Loading...."};
	sf::Text loading(Pic[0], loadingFont, 20);
	loading.setPosition(
...
//=====================================================================================================================
	...
	button[10]->connect("pressed", [&]() { gui.removeAllWidgets();
		T.viewPassengers();});
	...
	button[11]->connect("pressed", [&]() { gui.removeAllWidgets();
		T.addPassengers(); });
	...
	button[12]->connect("pressed", [&]() { gui.removeAllWidgets();
		T.removePassengers();});
