	...
	;; timer interrupt for ball movement
	;; keyboard interrupt for slider movement and notifications
...
old_kbisr:	dd 0		; space for storing old kbisr
old_tmisr:	dd 0		; so that to restore after execution
...
instructions:	db '<Enter key Start> <A: Left> <F: right> <Esc: escape>',0
...
printnum:
	;; prints a number at specified location
	;; with color given
	push bp
	mov bp,sp
	push es
