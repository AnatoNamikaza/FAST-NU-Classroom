...
public:
	...
	Snake() {
		cout << "Snake's Default Constructor." << endl;
	}

	Snake(int x) : Reptile(x) {
		cout << "Snake's Default Constructor." << endl;
	}
	...
	~Snake() {
		cout << "Snake's Default Desstructor." << endl;
	}
};
...
public:
	...
	Parrot() {
		cout << "Parrot's Default Constructor." << endl;
	}
	...
	~Parrot() {
		cout << "Parrot's Default Destructor." << endl;
	}
};
...
public:
	...
	Horse() {
		cout << "Horse's Default Constructor." << endl;
	}

	Horse(int x) : Mammal(x) {
		cout << "Horse's Default Constructor." << endl;
	}
	...
	~Horse() {
		cout << "Horse's Default Destructor." << endl;
	}
};
