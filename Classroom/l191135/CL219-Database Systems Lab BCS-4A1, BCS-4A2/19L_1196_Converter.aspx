<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="19L_1196_Converter.aspx.cs" Inherits="zaeemPlag._19L_1196_Converter" %>
...
<head runat="server">
    ...
    <script src="19L_1196_Converter.js"></script>
    <link rel="stylesheet" type="text/css" href="19L_1196_aspx.css"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox ID="TB1" runat="server" class="textField"  width =" 200" Height="25"></asp:TextBox>
            <br /> 
        </div>
        <p>
        ...
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox ID="TB2" runat="server"  class="textField"  width =" 200" Height="25"></asp:TextBox>
            <br /> 
            <br/>
        </div>
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox class="textField"  width =" 200" Height="25" ID="TB3" runat="server" ></asp:TextBox>
            <br /> 
        </div>
        ...
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox class="textField"  width =" 200" Height="25" ID="TB4" runat="server" ></asp:TextBox>
            <br />
            <br /> 
        </div>
        ...
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox class="textField"  width =" 200" Height="25" ID="TB5" runat="server" ></asp:TextBox>
            <br />
            <br /> 
        </div>
        ...
        <div class="global">
            ...
            <span class ="space"></span>
            <asp:TextBox class="textField"  width =" 200" Height="25" ID="TB6" runat="server" ></asp:TextBox>
            <br />
            <br /> 
        </div>
